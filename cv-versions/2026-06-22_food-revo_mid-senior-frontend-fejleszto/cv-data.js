 ...
 * @job-application: 2026-06-22_food-revo_mid-senior-frontend-fejleszto
 * @title: Mid/Senior frontend fejleszto (React, Mobil)
 * @company: Food Revo Kft.
 * @seniority: mid/senior
 * @domain: ettermi, rendesi, logisztikai platform
 * @ats-score: 85%
 * @operation: job-apply
...
export const CV_DATA = {
  ...
  summary:
    "Frontend Developer with 5+ years of experience building responsive, production web applications with React, Next.js, and TypeScript. I've developed scalable UI systems for enterprise platforms including admin dashboards, real-time interfaces, and API-driven applications. I introduced automated testing strategies, CI pipelines with quality gates, and code standards across teams. I focus on maintainable, component-based architecture and cross-browser compatibility.",
  workExperience: [
    {
      id: 'aegex',
      ...
      bullets: [
        'I developed responsive, API-driven frontend applications for two enterprise platforms (SafeSy, FACTS), building scalable admin dashboards and real-time interfaces',
