export const HU = {
  content: {
    summary:
      "Frontend fejlesztő vagyok 5+ év tapasztalattal reszponzív, produktív webes alkalmazások fejlesztésében React, Next.js és TypeScript technológiákkal. Skálázható UI rendszereket fejlesztettem vállalati platformokhoz, beleértve admin dashboardokat, valós idejű felületeket és API-vezérelt alkalmazásokat. Automatizált tesztelési stratégiákat, minőségi kapukkal ellátott CI pipeline-okat és kódszabványokat vezettem be. Karbantartható, komponensalapú architektúrára és böngészőfüggetlen kompatibilitásra fókuszálok.",
    workExperience: [
      {
        id: "aegex",
        description:
        ...
        bullets: [
          "Reszponzív, API-vezérelt frontend alkalmazásokat fejlesztettem két vállalati platformon (SafeSy, FACTS), skálázható admin dashboardokat és valós idejű felületeket építve",
