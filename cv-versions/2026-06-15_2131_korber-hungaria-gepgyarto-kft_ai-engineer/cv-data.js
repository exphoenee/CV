 ...
 * ============================================================
 * Optimized for: AI Engineer @ Körber Hungária Gépgyártó Kft.
 * Seniority:     mid
 * Domain:        industrial software / automation (Körber Technologies)
 * Date:          2026-06-15 21:31
 * ATS match:     62% (57% required · 73% preferred)
 * HR Review:     —
...
export const CV_DATA = {
  ...
  summary:
    "AI-augmented software engineer with 5+ years building and modernizing enterprise systems in TypeScript, Node.js, React, and Svelte. I've introduced AI-assisted development workflows and built CI pipelines with automated quality gates, significantly increasing delivery speed, engineering consistency, and release reliability. I design and integrate REST APIs and backend services end to end, and led full rewrites and migrations of legacy platforms to modern stacks. I lead and mentor engineers, focusing on evidence-driven refactoring, CI-quality standards, and sustainable, system-level engineering foundations.",
  workExperience: [
    {
      id: 'aegex',
      ...
      bullets: [
        ...
        'I introduced AI-assisted development workflows that improved engineering throughput, consistency, and code quality',
        'I implemented a CI pipeline with automated quality gates and a testing strategy from scratch, integrating REST APIs and backend services end to end',
    ...
    },
    {
      ...
      bullets: [
        ...
        'I integrated frontend interfaces with AI-driven backend services through REST API workflows',
  ...
  skillGroups: {
    ...
    backend: {
      list: ['REST API', 'Express.js', 'NestJS', 'Python', 'MySQL', 'MongoDB', 'WebSocket', 'PHP'],
      comment: null,
    },
    testing: {
