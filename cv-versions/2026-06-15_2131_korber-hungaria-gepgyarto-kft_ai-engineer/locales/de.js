export const DE = {
  content: {
    summary:
      'KI-gestützter Softwareentwickler mit über 5 Jahren Erfahrung im Aufbau und in der Modernisierung von Unternehmenssystemen mit TypeScript, Node.js, React und Svelte. Ich habe KI-gestützte Entwicklungs-Workflows eingeführt und CI-Pipelines mit automatisierten Quality Gates aufgebaut, was die Liefergeschwindigkeit, die technische Konsistenz und die Release-Zuverlässigkeit deutlich steigerte. Ich entwerfe und integriere REST-APIs und Backend-Services durchgängig und habe vollständige Rewrites sowie Migrationen von Legacy-Plattformen auf moderne Stacks geleitet. Ich leite und mentoriere Ingenieure mit Fokus auf evidenzbasiertes Refactoring, CI-Qualitätsstandards und nachhaltige, systemweite Engineering-Grundlagen.',
    workExperience: [
      {
        id: 'aegex',
        description:
          'Ich leitete die architektonische Modernisierung von SafeSy und FACTS mit vollständiger End-to-End-Verantwortung: Systemdesign, Frontend-Architektur und Backend-Integration. Die von mir eingeführten KI-gestützten Workflows und CI-Qualitätspipelines steigerten die Liefergeschwindigkeit und die Release-Zuverlässigkeit erheblich.',
        bullets: [
          ...
          'Ich führte KI-gestützte Entwicklungs-Workflows ein und steigerte Entwicklerdurchsatz, Konsistenz und Codequalität',
          'Ich implementierte eine CI-Pipeline mit automatisierten Quality Gates und einer Teststrategie von Grund auf und integrierte REST-APIs sowie Backend-Services durchgängig',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Ich integrierte Frontend-Interfaces mit KI-gesteuerten Backend-Services über REST-API-Workflows',
