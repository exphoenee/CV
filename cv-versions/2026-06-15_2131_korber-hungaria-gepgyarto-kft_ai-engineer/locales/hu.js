export const HU = {
  content: {
    summary:
      'AI-támogatott szoftvermérnök 5+ év tapasztalattal vállalati rendszerek építésében és modernizációjában TypeScript, Node.js, React és Svelte technológiákkal. AI-asszisztált fejlesztési munkafolyamatokat vezettem be, és automatizált minőségi kapukkal ellátott CI pipeline-okat építettem, jelentősen növelve a szállítási sebességet, a mérnöki konzisztenciát és a kiadások megbízhatóságát. REST API-kat és backend szolgáltatásokat tervezek és integrálok végponttól végpontig, és legacy platformok teljes újraírását és modern stackekre való migrációját vezettem. Mérnököket vezetek és mentorálok, az evidencián alapuló refaktorálásra, a CI-minőségi sztenderdekre és a fenntartható, rendszerszintű mérnöki alapokra fókuszálva.',
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          ...
          'AI-asszisztált fejlesztési munkafolyamatokat vezettem be, javítva a mérnöki teljesítményt, a konzisztenciát és a kódminőséget',
          'CI pipeline-t implementáltam automatizált minőségi kapukkal és tesztelési stratégiával a semmiből, REST API-kat és backend szolgáltatásokat végponttól végpontig integrálva',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Frontend interfészeket integráltam AI-vezérelt backend szolgáltatásokkal REST API munkafolyamatokon keresztül',
