export const IT = {
  content: {
    summary:
      "Ingegnere del software potenziato dall'IA con oltre 5 anni di esperienza nella creazione e nella modernizzazione di sistemi aziendali con TypeScript, Node.js, React e Svelte. Ho introdotto flussi di lavoro di sviluppo assistiti dall'IA e costruito pipeline CI con quality gate automatizzati, migliorando significativamente la velocità di consegna, la coerenza tecnica e l'affidabilità dei release. Progetto e integro API REST e servizi backend end-to-end, e ho guidato riscritture complete e migrazioni di piattaforme legacy verso stack moderni. Guido e mentoro ingegneri, concentrandomi sul refactoring basato su evidenze, sugli standard di qualità CI e su fondamenta di ingegneria sostenibili a livello di sistema.",
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          ...
          "Ho introdotto flussi di lavoro di sviluppo assistiti dall'IA migliorando la produttività, la coerenza e la qualità del codice del team",
          "Ho implementato un pipeline CI con quality gate automatizzati e strategia di test da zero, integrando API REST e servizi backend end-to-end",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Ho integrato interfacce frontend con servizi backend guidati dall'IA tramite workflow di API REST",
