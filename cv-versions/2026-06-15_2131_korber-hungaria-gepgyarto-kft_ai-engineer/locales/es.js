export const ES = {
  content: {
    summary:
      'Ingeniero de software aumentado por IA con más de 5 años de experiencia construyendo y modernizando sistemas empresariales con TypeScript, Node.js, React y Svelte. He introducido flujos de trabajo de desarrollo asistidos por IA y construido pipelines CI con quality gates automatizados, mejorando significativamente la velocidad de entrega, la consistencia técnica y la fiabilidad de los releases. Diseño e integro APIs REST y servicios backend de extremo a extremo, y he liderado reescrituras completas y migraciones de plataformas legacy a stacks modernos. Lidero y mentorizo a ingenieros, enfocándome en el refactoring basado en evidencias, los estándares de calidad CI y en bases de ingeniería sostenibles a nivel de sistema.',
    workExperience: [
      {
        id: 'aegex',
        description:
          'Lideré la modernización arquitectónica de SafeSy y FACTS con responsabilidad completa de extremo a extremo: diseño de sistemas, arquitectura frontend e integración backend. Los flujos de trabajo asistidos por IA y los pipelines CI que introduje mejoraron significativamente la velocidad de entrega y la fiabilidad de los releases.',
        bullets: [
          ...
          'Introduje flujos de trabajo de desarrollo asistidos por IA mejorando el rendimiento, la consistencia y la calidad del código del equipo',
          'Implementé un pipeline CI con quality gates automatizados y una estrategia de pruebas desde cero, integrando APIs REST y servicios backend de extremo a extremo',
          'Establecí un proceso de refactoring basado en evidencias con mejoras de calidad claramente medibles',
          'Actualmente mentorizo y lidero a 1 ingeniero de nivel intermedio',
        ],
        projects: [
          {
            name: 'SafeSy',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Integré interfaces frontend con servicios backend impulsados por IA mediante flujos de trabajo de API REST',
          'Construí interfaces de visualización de datos en tiempo real para resultados de pruebas y análisis de sistemas',
          'Trabajé en un entorno Agile con integración continua de sistemas frontend y backend',
        ],
      },
      {
        id: 'scolia',
