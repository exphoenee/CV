export const KL = {
  content: {
    summary:
      "AI-boQ ghItlh ta'wI' jIH — 5+ DIS pat chu' vIchenmoH ma vISaH TypeScript, Node.js, React, Svelte. AI qoq mIwmey vIazh ma CI HeH vIchenmoH — HeH cendmey nargh — Qu' ray' Qap, ngeHlu' batlh, ghItlh QaQ taH. REST-API ma qo' naQHom vISamoH 'eD 'eD, ma pat ngo' vIchenqa' vIvumpu'. SuvwI'pu' vISa' ma vIHaDmoH, De' legh ngeHlu' ma CI-batlh vIvum. Qapla'!",
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          ...
          "AI qoq mIwmey vIazh — ghom Qu' Qap ray', ghItlh QaQ taH",
          "CI HeH vIchenmoH — De' legh pagh lI'be', Qu' taH, REST-API ma qo' naQHom vISamoH 'eD 'eD",
      ...
      },
      {
        ...
        bullets: [
          ...
          "HoS naQHom lojmItmey vIchenmoH AI qo' naQHom REST-API jabbI'ID mIwmey",
