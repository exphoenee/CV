 ...
 * @job-application: 2026-06-22_kraken_senior-software-engineer-frontend-pro
 * @title: Senior Software Engineer - Frontend - Pro
 * @company: Kraken
 * @seniority: senior
 * @domain: crypto, fintech, open finance
 * @ats-score: 60%
 * @operation: job-apply
...
export const CV_DATA = {
  ...
  summary:
    "Senior Software Engineer with 5+ years of experience building production web applications with React, TypeScript, and Node.js. I've designed and maintained scalable, maintainable frontend systems across enterprise platforms, including WebSocket-based real-time architectures and Next.js applications. I introduced automated testing strategies, CI pipelines with quality gates, and API design best practices. I mentor engineers, lead complex technical initiatives, and use AI-assisted development workflows to multiply engineering output.",
  workExperience: [
    {
      id: "aegex",
      ...
      bullets: [
        "I designed and implemented scalable, maintainable, and fault-tolerant frontend systems for two enterprise platforms (SafeSy, FACTS), with deep focus on performance optimization and complex software architecture",
