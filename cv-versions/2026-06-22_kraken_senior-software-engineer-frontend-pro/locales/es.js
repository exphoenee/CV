export const ES = {
  content: {
    summary:
      "Senior Software Engineer con más de 5 años de experiencia desarrollando aplicaciones web productivas con React, TypeScript y Node.js. He diseñado y mantenido sistemas frontend escalables y mantenibles en plataformas empresariales, incluyendo arquitecturas en tiempo real basadas en WebSocket y aplicaciones Next.js. He introducido estrategias de prueba automatizada, pipelines CI con quality gates y mejores prácticas de diseño de API. Mentorizo a ingenieros, lidero iniciativas técnicas complejas y uso flujos de trabajo de desarrollo asistidos por IA.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Diseñé e implementé sistemas frontend escalables, mantenibles y tolerantes a fallos para dos plataformas empresariales (SafeSy, FACTS), con enfoque profundo en optimización de rendimiento y arquitectura de software compleja",
