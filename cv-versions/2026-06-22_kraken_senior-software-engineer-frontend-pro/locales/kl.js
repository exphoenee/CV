export const KL = {
  content: {
    summary:
      "HoS naQHom wa'DIch jIH — 5+ DIS HoS naQHom quenta ghItlhmey meQ React, TypeScript ma Node.js. lurDech patmey vIchel TypeScript, Svelte, React, Node.js. jIvumpu' DaH. patmey vIchel — WebSocket De' legh, Next.js quenta. HeH patmey vIchel, CI HeH, API batlh. SuvwI'pu' vISa' ma vIHaDmoH. De' legh patmey vIvum. Qapla'!",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "pat vIchenmoH — De' leghmoH ma patmey vIchel: qech → chen → Qu' taH",
