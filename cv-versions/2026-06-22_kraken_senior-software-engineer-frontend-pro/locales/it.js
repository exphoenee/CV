export const IT = {
  content: {
    summary:
      "Senior Software Engineer con oltre 5 anni di esperienza nello sviluppo di applicazioni web produttive con React, TypeScript e Node.js. Ho progettato e mantenuto sistemi frontend scalabili e manutenibili su piattaforme aziendali, incluse architetture real-time basate su WebSocket e applicazioni Next.js. Ho introdotto strategie di test automatizzati, pipeline CI con quality gate e migliori pratiche di design delle API. Fornisco mentorship a ingegneri, guido iniziative tecniche complesse e utilizzo workflow di sviluppo assistiti dall'IA.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Ho progettato e implementato sistemi frontend scalabili, manutenibili e tolleranti ai guasti per due piattaforme aziendali (SafeSy, FACTS), con focus profondo sull'ottimizzazione delle prestazioni e sull'architettura software complessa",
