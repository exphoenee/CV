export const HU = {
  content: {
    summary:
      "Senior Software Engineerként 5+ év tapasztalattal rendelkezem React, TypeScript és Node.js technológiákkal épített produktív webes alkalmazások fejlesztésében. Skálázható, karbantartható frontend rendszereket terveztem és tartottam fenn vállalati platformokon, beleértve WebSocket-alapú valós idejű architektúrákat és Next.js alkalmazásokat. Automatizált tesztelési stratégiákat, minőségi kapukkal ellátott CI pipeline-okat és API-tervezési best practice-eket vezettem be. Mérnököket mentorálok, összetett technikai kezdeményezéseket vezetek, és AI-asszisztált fejlesztési munkafolyamatokkal szorzom a mérnöki teljesítményt.",
    workExperience: [
      {
        id: "aegex",
        description:
        ...
        bullets: [
          "Skálázható, karbantartható és hibatűrő frontend rendszereket terveztem és valósítottam meg két vállalati platformon (SafeSy, FACTS), mély fókusszal a teljesítményoptimalizálásra és az összetett szoftverarchitektúrára",
    ...
    community:
      'Pro bono iskolai informatika és programozási szakkört indítottam és vezetek a pécsi Mátyás Király Utcai Általános Iskolában (2026. február, folyamatban). Teljes tananyagot terveztem. Mentorálásomnak köszönhetően a csapat első helyet szerzett a 2026-os „Hack and Code" versenyen és 1. és 3. helyet a 22. Neumann János Programozási Versenyen.',
