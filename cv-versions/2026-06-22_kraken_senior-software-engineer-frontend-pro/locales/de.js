export const DE = {
  content: {
    summary:
      "Senior Software Engineer mit über 5 Jahren Erfahrung in der Entwicklung produktiver Webanwendungen mit React, TypeScript und Node.js. Ich habe skalierbare, wartbare Frontend-Systeme für Unternehmensplattformen entworfen und gewartet, darunter WebSocket-basierte Echtzeit-Architekturen und Next.js-Anwendungen. Ich habe automatisierte Teststrategien, CI-Pipelines mit Quality Gates und API-Design-Best-Practices eingeführt. Ich mentoriere Ingenieure, leite komplexe technische Initiativen und nutze KI-gestützte Entwicklung Workflows zur Vervielfachung der Engineering-Leistung.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Ich habe skalierbare, wartbare und fehlerresistente Frontend-Systeme für zwei Unternehmensplattformen (SafeSy, FACTS) entworfen und implementiert, mit tiefem Fokus auf Leistungsoptimierung und komplexe Softwarearchitektur",
