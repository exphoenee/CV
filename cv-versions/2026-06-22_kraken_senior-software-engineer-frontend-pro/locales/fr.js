export const FR = {
  content: {
    summary:
      "Senior Software Engineer avec plus de 5 ans d'expérience dans le développement d'applications web productives avec React, TypeScript et Node.js. J'ai conçu et maintenu des systèmes frontend scalables et maintenables sur des plateformes d'entreprise, incluant des architectures temps réel basées sur WebSocket et des applications Next.js. J'ai introduit des stratégies de test automatisé, des pipelines CI avec quality gates et des meilleures pratiques de conception d'API. Je forme des ingénieurs, dirige des initiatives techniques complexes et utilise des workflows de développement assistés par IA.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "J'ai conçu et implémenté des systèmes frontend scalables, maintenables et tolérants aux pannes pour deux plateformes d'entreprise (SafeSy, FACTS), avec un focus profond sur l'optimisation des performances et l'architecture logicielle complexe",
      ...
      },
      {
        ...
        bullets: [
          ...
          "J'ai amélioré la cohérence de l'architecture frontend en définissant des standards de code dans l'équipe",
