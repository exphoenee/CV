export const HU = {
  content: {
    summary:
      "Szoftvermérnökként 5+ év frontend tapasztalattal építek production alkalmazásokat React, TypeScript és Node.js segítségével. Erős technikai tudást párosítok product mindsettel — fókuszban az eredmények, használhatóság és karbantartható, jól tesztelt rendszerek. Szállítottam valós idejű frontendet sportanalitikához, építettem CI pipeline-t automatizált minőségi kapukkal, és vezettem be AI-asszisztált workflow-kat a szállítási sebesség növelésére minőségromlás nélkül. Tapasztalatom van Agile/Scrum környezetben, egység- és integrációs tesztekben, valamint komponenskönyvtárak és mérnöki sztenderdek kialakításában.",
    workExperience: [
      {
        id: "aegex",
        description:
      ...
      },
      {
        ...
        bullets: [
          ...
          "Alacsony késleltetésű vizualizációs komponenseket implementáltam analitikához",
