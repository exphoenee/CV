 ...
 * ============================================================
 * Optimized for: Software Engineer @ PrestoSports
 * Seniority:     mid/senior
 * Domain:        collegiate sports technology
 * Date:          2026-06-23 19:53
 * ATS match:     87% (100% required · 58% preferred)
 * HR Review:     —
 * Changes:       4 modifications (summary · skill order · 2 bullet rephrases)
...
export const CV_DATA = {
  ...
  summary:
    "Software Engineer with 5+ years of frontend experience building production applications with React, TypeScript, and Node.js. I combine strong technical execution with a product mindset — I care about outcomes, usability, and building maintainable, well-tested systems. I've delivered real-time data-driven frontends for sports analytics, built CI pipelines with automated quality gates, and introduced AI-assisted development workflows to accelerate delivery without sacrificing quality. I bring experience working in Agile/Scrum environments, writing unit and integration tests, and contributing to shared component libraries and engineering standards.",
  workExperience: [
    {
      id: 'aegex',
      ...
      projects: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'I implemented a CI pipeline with automated quality gates and comprehensive testing strategy, reducing production issues and improving release reliability in an Agile delivery environment',
