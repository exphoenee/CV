export const ES = {
  content: {
    summary:
      "Senior Frontend Developer con más de 5 años de experiencia desarrollando aplicaciones web de alta calidad y amigables con el usuario con React, TypeScript y frameworks frontend modernos. He liderado decisiones arquitectónicas sobre stacks tecnológicos, frameworks y herramientas de desarrollo en sistemas empresariales, impulsando la consistencia de la arquitectura frontend y el diseño UI escalable. He introducido estándares de código, estrategias de prueba automatizada y pipelines CI con quality gates, mejorando la velocidad de entrega y las prácticas de desarrollo. Mentorizo a desarrolladores junior, lidero la colaboración entre funciones y me mantengo actualizado con tecnologías emergentes.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Lideré decisiones arquitectónicas sobre stacks tecnológicos, frameworks y herramientas para dos sistemas empresariales (SafeSy, FACTS), asegurando la entrega end-to-end desde el diseño hasta la producción",
          ...
          "Proporciono mentoría y orientación a un desarrollador frontend junior, apoyando su crecimiento y desarrollo técnico",
        ],
        projects: [
          {
            name: "SafeSy",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Aseguré la adherencia a estándares de código y mejores prácticas definiendo e imponiendo la consistencia de la arquitectura frontend en el equipo",
    ...
    community:
      'Puse en marcha y dirijo un club extraescolar de informática y programación gratuito en la Escuela Primaria de la Calle Mátyás Király en Pécs (febrero 2026, en curso). Diseñé el currículum completo. Bajo mi mentoría, el equipo ganó el 1er lugar en el concurso "Hack and Code" 2026 y quedó 1° y 3° en el 22° Concurso de Programación Neumann János.',
