export const DE = {
  content: {
    summary:
      "Senior Frontend Developer mit über 5 Jahren Erfahrung in der Entwicklung hochwertiger Webanwendungen mit React, TypeScript und modernen Frontend-Frameworks. Ich habe architektonische Entscheidungen zu Technologiestacks und Entwicklungstools in Unternehmenssystemen geleitet. Ich habe Coding Standards, automatisierte Teststrategien und CI-Pipelines mit Quality Gates eingeführt. Ich mentoriere Junior-Entwickler und leite cross-functional Zusammenarbeit.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Ich leitete architektonische Entscheidungen über Technologiestacks, Frameworks und Tools für zwei Unternehmenssysteme (SafeSy, FACTS) und stellte die End-to-End-Lieferung vom Design bis zur Produktion sicher",
          ...
          "Ich biete Mentoring und Anleitung für Junior-Frontend-Entwickler, um ihre berufliche und technische Entwicklung zu unterstützen",
        ],
        projects: [
          {
            name: "SafeSy",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Ich stellte die Einhaltung von Coding Standards und Best Practices sicher, indem ich Frontend-Architektur-Konsistenz im Team definierte und durchsetzte",
