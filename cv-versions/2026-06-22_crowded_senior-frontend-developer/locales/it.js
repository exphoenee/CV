export const IT = {
  content: {
    summary:
      "Senior Frontend Developer con oltre 5 anni di esperienza nello sviluppo di applicazioni web con React, TypeScript e framework frontend moderni. Ho guidato decisioni architetturali su stack tecnologici e strumenti di sviluppo in sistemi aziendali. Ho introdotto standard di codice, strategie di test automatizzati e pipeline CI con quality gate. Fornisco mentorship a sviluppatori frontend junior e guido la collaborazione cross-functionale.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "Ho guidato decisioni architetturali su stack tecnologici, framework e strumenti per due sistemi aziendali (SafeSy, FACTS), garantendo la consegna end-to-end dal design alla produzione",
          ...
          "Fornisco mentorship e guidanza a uno sviluppatore frontend junior, supportando la sua crescita e il suo sviluppo tecnico",
        ],
        projects: [
          {
            name: "SafeSy",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Ho garantito l'adesione agli standard di codice e alle best practice definendo e applicando la coerenza dell'architettura frontend nel team",
    ...
    community:
      "Ho avviato e guido un club scolastico gratuito di informatica e programmazione presso la Scuola Primaria di Via Mátyás Király a Pécs (febbraio 2026, in corso). Ho progettato l'intero programma didattico. Sotto la mia mentorship, il team ha vinto il 1° posto al concorso «Hack and Code» 2026 e si è classificato 1° e 3° al 22° Concorso di Programmazione Neumann János.",
