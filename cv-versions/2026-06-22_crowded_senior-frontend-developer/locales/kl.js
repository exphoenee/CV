export const KL = {
  content: {
    summary:
      "HoS naQHom wa'DIch jIH — 5+ DIS HoS naQHom Hoch-naQHom Qu'mey vIta' meQ React, TypeScript ma nagh nov naQHom. lurDech patmey vIchel TypeScript, Svelte, React, Node.js. jIvumpu' DaH. jIvum HeH patmey vIchel — De' legh patmey vIvum — Qu' ray' Qap, ngeHlu' batlh. SuvwI'pu' vISa' ma vIHaDmoH. De' legh patmey vIvum. HoS naQHomlIj boQmeH jIvum. Qapla'!",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "pat vIchenmoH vIvumpu' — lurDech patmey vIchel: qech → chen → Qu' taH",
          ...
          "HoS naQHom chenmoHwI' vISa' — Qapla' ma vIHaDmoH, ngeHlu' batlh",
        ],
        projects: [
          {
            name: "SafeSy",
      ...
      },
      {
        ...
        bullets: [
          ...
          "pat HoS naQHom batlh vIchav — HeH Qapla' vIazh, De' legh patmey batlh",
