export const FR = {
  content: {
    summary:
      "Senior Frontend Developer avec plus de 5 ans d'expérience dans le développement d'applications web avec React, TypeScript et des frameworks frontend modernes. J'ai dirigé des décisions architecturales sur les technologies et outils de développement dans des systèmes d'entreprise. J'ai introduit des standards de code, des stratégies de test automatisé et des pipelines CI avec quality gates. Je forme des développeurs junior et dirige la collaboration inter-fonctionnelle.",
    ...
    workExperience: [
      {
        ...
        bullets: [
          "J'ai dirigé les décisions architecturales sur les technologies, frameworks et outils pour deux systèmes d'entreprise (SafeSy, FACTS), assurant la livraison de bout en bout du design à la production",
          ...
          "Je fournis mentorat et guidance à un développeur frontend junior, soutenant sa croissance et son développement technique",
        ],
        projects: [
          {
            name: "SafeSy",
      ...
      },
      {
        ...
        bullets: [
          ...
          "J'ai assuré le respect des standards de code en définissant et appliquant la cohérence de l'architecture frontend dans l'équipe",
