 ...
 * @job-application: 2026-06-22_crowded_senior-frontend-developer
 * @title: Senior Frontend Developer
 * @company: Crowded
 * @seniority: senior
 * @domain: fintech, group banking, embedded finance
 * @ats-score: 45%
 * @operation: job-apply
...
export const CV_DATA = {
  ...
  summary:
    "Senior Frontend Developer with 5+ years of experience building high-quality, user-friendly web applications with React, TypeScript, and modern frontend frameworks. I've led architectural decisions on technology stacks, frameworks, and development tools across enterprise systems, driving frontend architecture consistency and scalable UI design. I introduced coding standards, automated testing strategies, and CI pipelines with quality gates, improving delivery speed and engineering practices. I mentor junior developers, lead cross-functional collaboration, and stay current with emerging technologies to improve development workflows.",
  workExperience: [
    {
      id: "aegex",
      ...
      bullets: [
        "I led architectural decisions on technologies, frameworks, and tools for two enterprise systems (SafeSy, FACTS), driving end-to-end delivery from design to production",
        ...
        "I provide mentorship and guidance to a junior front-end developer, supporting their growth and technical development",
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        "I ensured adherence to coding standards and best practices by defining and enforcing frontend architecture consistency across the team",
