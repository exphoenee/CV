 ...
 * ============================================================
 * Optimized for: Frontend Developer (Vue.js) @ Deutsche Telekom IT Solutions
 * Seniority:     senior
 * Domain:        enterprise IT services, telecommunications, cloud-native microservice architecture
 * Date:          2026-08-29 21:59
 * ATS match:     51% (58% required · 33% preferred)
 * HR Review:     —
 * Changes:       4 modifications (summary rewrite · skill order · 2 bullet rephrases + 1 bullet extension)
