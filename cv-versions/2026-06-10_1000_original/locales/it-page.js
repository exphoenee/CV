export const IT_PAGE = {
  labels: {
    ...
    bookPendingTitle: "Quasi fatto — conferma la prenotazione",
    bookPendingNote: "Ti abbiamo inviato un link di conferma via email. Aprilo entro 30 minuti per finalizzare: l'orario non è riservato finché non confermi.",
    bookErrDateFull: "Quel giorno è già prenotato. Scegli un altro giorno.",
