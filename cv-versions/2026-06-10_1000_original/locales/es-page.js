export const ES_PAGE = {
  labels: {
    ...
    bookPendingTitle: 'Casi listo: confirma tu reserva',
    bookPendingNote: 'Te enviamos un enlace de confirmación por correo. Ábrelo en 30 minutos para finalizar: la cita no queda reservada hasta que confirmes.',
    bookErrDateFull: 'Ese día ya está reservado. Elige otro día.',
