export const ASG_PAGE = {
  labels: {
    ...
    bookPendingTitle: 'Næstum lokið — staðfest bókun þína',
    bookPendingNote: 'Vér sendum hlekk í póst. Opna innan 30 mín — tími frátekinn við staðfestingu.',
    bookErrDateFull: 'Sá dagur er þegar bókaður. Kjós annan dag.',
