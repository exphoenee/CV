 ...
 * ============================================================
 * Optimized for: Senior Frontend Engineer (React / TypeScript) @ BlueThrone
 * Seniority:     senior
 * Domain:        mobile app monetization, internal platform
 * Date:          2026-06-23 21:45
 * ATS match:     68% (83% required · 33% preferred)
 * HR Review:     —
 * Changes:       3 modifications (summary · SafeSy bullet · Scolia bullet)
...
export const CV_DATA = {
  ...
  summary:
    "Senior Frontend Engineer with 5+ years building complex, data-rich web apps (React, TypeScript, Vite, Webpack). I combine technical execution with a product mindset — outcomes, usability, scalable internal platforms. I've delivered enterprise internal platforms with data visualization, analytics dashboards, and admin tooling; built CI pipelines; and introduced AI-assisted workflows to accelerate delivery without sacrificing quality. I bring strong experience with state management (Redux), shared component libraries, and owning frontend architecture end-to-end in Agile/Scrum environments.",
  workExperience: [
    {
      id: 'aegex',
      ...
      projects: [
        {
          ...
          bullets: [
            'I built a cross-role enterprise internal platform with real-time data visualization, analytics dashboards, and admin tooling for production, office, executives, and partners',
        ...
        },
        {
          ...
          bullets: [
            'I reduced the release cycle from monthly to biweekly (target: weekly) using AI-assisted workflows (Claude)',
            'I built a CI pipeline with automated quality gates and testing strategy, cutting production issues and improving release reliability',
            'I migrated the architecture to a PNPM monorepo, extracting the shared FACTS/Driver package',
            'I built internal CLI tooling for monorepo automation and developer productivity',
          ],
        },
      ],
    ...
    },
    {
      ...
      bullets: [
        'I built a real-time React-based UI for live sports scoring and match tracking in a high-reliability, live-event environment',
        'I built low-latency analytics dashboards and data visualization components for live performance metrics',
  ...
  skillGroups: {
    primary: {
      list: ['TypeScript', 'React', 'JavaScript', 'Node.js', 'SCSS', 'HTML', 'CSS', 'Svelte'],
      comment: null,
    },
    backend: {
  ...
  hobbyProjects: [
    ...
    { name: 'Auditorium', url: 'https://exphoenee.github.io/auditorium/' },
