 ...
 * ============================================================
 * Optimized for: AI Specialist Sustainability @ ismeretlen (SWICON partner)
 * Seniority:     mid
 * Domain:        sustainability, ESG, tobacco, food industry machinery
 * Date:          2026-06-19 22:54
 * ATS match:     58% (69% required · 33% preferred)
 * HR Review:     review/2026-06-19_2256_hr-review-ai-specialist-sustainability.md
 * Changes:       3 modifications (summary reword · backend skill order · 3 bullet rephrases)
...
export const CV_DATA = {
  ...
  summary:
    "Engineer and Tech Lead with 5+ years in software development and 13 years in industrial engineering, specializing in AI-assisted development, data automation, and system design with TypeScript, Node.js, Python, and SQL. I've introduced AI-driven development workflows and built CI pipelines with automated quality gates. I've automated data flows and reporting processes, built daily email reporting systems and real-time data visualization interfaces, and contributed to platforms for environmental compliance tracking. I lead and mentor engineers, focusing on evidence-driven, analytical, and structured solution delivery across teams.",
  workExperience: [
    {
      id: 'aegex',
      ...
      projects: [
        {
          ...
          bullets: [
            ...
            'I automated reporting processes with a subscribable daily email reporting system, and integrated data sources via the Express backend (SQL query design and optimization)',
          ],
        },
        {
          name: 'FACTS',
    ...
    },
    {
      ...
      bullets: [
        ...
        'I built real-time data visualization and dashboard interfaces for monitoring test results and system analysis',
    ...
    },
    {
      ...
      bullets: [
        ...
        'I established KPIs, documentation standards, and automated reporting processes for engineering operations',
  ...
  skillGroups: {
    primary: {
      list: ['TypeScript', 'JavaScript', 'Node.js', 'Svelte', 'React', 'SCSS', 'HTML', 'CSS'],
      comment: null,
    },
    backend: {
