export const IT = {
  content: {
    summary:
      "Senior Frontend Engineer con 5+ anni di esperienza in applicazioni React e TypeScript. Specializzato in architettura frontend, stato Redux, componenti riutilizzabili e ottimizzazione performance. Ho guidato riscritture di sistemi aziendali con test CI (Jest, Vitest, Playwright) e flussi IA che hanno raddoppiato la frequenza dei release. Mentoro ingegneri, promuovo refactoring basato su evidenze e mi concentro su frontend accessibili e cross-browser.",
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          'Ho preso in carico architettura e consegna end-to-end di due sistemi aziendali React/TypeScript (SafeSy, FACTS), inclusa progettazione del sistema, architettura UI con gestione dello stato in stile Redux, e stretta collaborazione con team backend e di integrazione',
          ...
          'Ho implementato un pipeline CI con test automatizzati (Jest, Vitest, Playwright) e quality gate, costruendo copertura dei test da zero e riducendo significativamente i problemi in produzione',
      ...
      },
      {
        ...
        bullets: [
          "Ho sviluppato componenti UI React type-safe con gestione dello stato Redux per sistemi aziendali integrati con l'IA, collaborando con i team backend sui workflow di integrazione API",
