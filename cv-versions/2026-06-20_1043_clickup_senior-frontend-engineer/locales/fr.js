export const FR = {
  content: {
    summary:
      "Senior Frontend Engineer avec 5+ ans d'expérience dans la création d'applications React et TypeScript. Spécialisé en architecture frontend, gestion d'état Redux, composants réutilisables et optimisation des performances. J'ai dirigé des réécritures de systèmes d'entreprise avec des tests CI (Jest, Vitest, Playwright) et des workflows IA qui ont doublé la fréquence des releases. Je mentore des ingénieurs, promeus le refactoring basé sur les preuves et privilégie des frontends accessibles et multi-navigateurs.",
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          "J'ai pris en charge l'architecture et la livraison de bout en bout de deux systèmes d'entreprise React/TypeScript (SafeSy, FACTS), incluant la conception système, l'architecture UI avec gestion d'état de type Redux, et une collaboration étroite avec les équipes backend et d'intégration",
          ...
          "J'ai mis en place un pipeline CI avec des tests automatisés (Jest, Vitest, Playwright) et des quality gates, en construisant la couverture de test de zéro et en réduisant significativement les incidents de production",
      ...
      },
      {
        ...
        bullets: [
          "J'ai développé des composants UI React type-safe avec gestion d'état Redux pour des systèmes d'entreprise intégrés à l'IA, en collaborant avec les équipes backend sur les workflows d'intégration API",
