export const DE = {
  content: {
    summary:
      'Senior Frontend Engineer mit 5+ Jahren Erfahrung in React- und TypeScript-Entwicklung. Spezialisiert auf Frontend-Architektur, Redux-State-Management, Komponentensysteme und Performance-Optimierung. Leitete Unternehmens-Neuentwicklungen mit CI-Teststrategien (Jest, Vitest, Playwright) und KI-Workflows, die die Release-Frequenz verdoppelten. Ich mentoriere Ingenieure, fördere evidenzbasiertes Refactoring und setze auf barrierefreie, Cross-Browser-kompatible Frontends.',
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          'Ich übernahm Architektur und End-to-End-Lieferung zweier Unternehmenssysteme (SafeSy, FACTS) — React/TypeScript, UI-Architektur mit Redux-State-Management, enge Zusammenarbeit mit Backend- und Integrationsteams',
          ...
          'Ich implementierte eine CI-Pipeline mit automatisierten Tests (Jest, Vitest, Playwright) und Quality Gates, baute Testabdeckung von Null auf und reduzierte Produktionsprobleme signifikant',
      ...
      },
      {
        ...
        bullets: [
          'Ich entwickelte typsichere React-basierte UI-Komponenten mit Redux-State-Management für KI-integrierte Unternehmenssysteme, in Zusammenarbeit mit Backend-Teams an API-Integrations-Workflows',
