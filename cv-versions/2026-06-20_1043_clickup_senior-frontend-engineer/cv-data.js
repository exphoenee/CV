 ...
 * ============================================================
 * Optimized for: Senior Frontend Engineer @ ClickUp
 * Seniority:     senior
 * Domain:        AI-native workspace / SaaS / productivity
 * Date:          2026-06-20 10:43
 * ATS match:     90% (90% required · —% preferred)
 * HR Review:     —
 * Changes:       4 modifications (summary · 2 Aegex bullets · 1 Telekom bullet)
 ...
 */
// @job-application: 2026-06-15_manual — Manual Backup @ — (2026-06-15) · snapshot: cv-versions/2026-06-15_manual/
// @cv-last-change: 2026-06-15 1024 — cv-restore (cv-restore) · see cv-versions/history.md
/**
 * cv-data.js
...
export const CV_DATA = {
  ...
  summary:
    "Senior Frontend Engineer with 5+ years of experience building and modernizing large-scale React and TypeScript applications. I specialize in frontend architecture, Redux-style state management, reusable component systems, and frontend performance optimization. I've led full rewrites of enterprise systems, established CI-driven testing strategies with Jest, Vitest, and Playwright, and introduced AI-assisted development workflows that doubled release frequency. I mentor engineers, champion evidence-driven refactoring, and focus on building sustainable, high-quality frontend foundations with accessibility and cross-browser compatibility.",
  workExperience: [
    {
      id: 'aegex',
      ...
      bullets: [
        'I own the architecture and end-to-end delivery of two enterprise React/TypeScript systems (SafeSy, FACTS), including system design, UI architecture with Redux-style state management, and close collaboration with backend and integrations teams',
        ...
        'I implemented a CI pipeline with automated testing (Jest, Vitest, Playwright) and quality gates, building test coverage from zero and significantly reducing production issues',
    ...
    },
    {
      ...
      bullets: [
        'I developed type-safe React-based UI components with Redux state management for enterprise AI-integrated systems, collaborating with backend teams on API integration workflows',
  ...
  skillGroups: {
    ...
    tooling: {
      list: ['Vite', 'Webpack', 'PNPM', 'Next.js', 'CI/CD'],
      comment: null,
    },
    ai: {
      list: ['Claude', 'Codex'],
