// @job-application: 2026-06-22_food-revo_mid-senior-frontend-fejleszto — Mid/Senior frontend fejleszto @ Food Revo Kft. (2026-06-22) · snapshot: cv-versions/2026-06-22_food-revo_mid-senior-frontend-fejleszto/
// @cv-last-change: 2026-06-22 0900 — job-apply (job-apply-orchestrator) · see cv-versions/history.md
export const HU = {
  content: {
    summary:
      "Full Stack Fejlesztő vagyok 5+ év tapasztalattal produktív szoftverek szállításában React, TypeScript és Node.js technológiákkal. Jellemzően end-to-end felelősséget vállaltam a funkciókért — architektúrától és UI-tól a backend integrációig és telepítésig — vállalati platformokon. Claude Code és Codex power user vagyok, AI-t használok erőszorzóként a fejlesztés gyorsítására miközben fenntartom a mérnöki minőséget. Tiszta kódra, gyors iterációra és olyan eszközök építésére fókuszálok, amelyek hatékonyabbá teszik a csapatokat.",
    workExperience: [
      {
        id: "aegex",
        description:
        ...
        bullets: [
          "End-to-end felelősséget vállaltam két vállalati platform funkcióiért (SafeSy, FACTS) — architektúra, UI, backend integráció és telepítés — produktív szoftvert szállítva React, TypeScript és Node.js technológiákkal",
