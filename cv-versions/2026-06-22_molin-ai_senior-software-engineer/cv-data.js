...
export const CV_DATA = {
  ...
  summary:
    "Full Stack Developer with 5+ years of experience shipping production software with React, TypeScript, and Node.js. I've owned features end to end — from architecture and UI to backend integration and deployment — across enterprise platforms. I'm a power user of Claude Code and Codex, using AI as a force multiplier to accelerate development while maintaining engineering quality. I focus on clean code, fast iteration, and building tools that make teams more productive.",
  workExperience: [
    {
      id: "aegex",
      ...
      bullets: [
        "I owned features end to end for two enterprise platforms (SafeSy, FACTS) — architecture, UI, backend integration, and deployment — shipping production software with React, TypeScript, and Node.js",
