...
_Generálta: arch-review-agent_  
_Forrás: scripts/cv-data.js · scripts/shared.js · scripts/locales/ · styles/ · cv-_.html\*  
_Constraint: A site marad statikus HTML+CSS+JS, build lépés nélkül futtatható._
```
