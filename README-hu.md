...
> 🌐 **Nyelv:** [🇬🇧 English](README.md) · 🇭🇺 Magyar
...
A teljes mezőszintű séma (típusok, kötelező/opcionális mezők, példák) a [devdocs/cv-data-schema-hu.md](devdocs/cv-data-schema-hu.md) dokumentumban található.
...
A motor részletes fejlesztői dokumentációja (új station/entitás hozzáadása, BMP → tilemap pipeline, collision rendszer, dialogue rendszer, térkép szerkesztése) a [devdocs/game-dev-notes-hu.md](devdocs/game-dev-notes-hu.md) fájlban olvasható.
...
A skill-ek, agent-ek, azok adatfolyamai, valamint a teljes job-apply pipeline lépésenkénti leírása (Mermaid diagramokkal) a [devdocs/ai-workflow-hu.md](devdocs/ai-workflow-hu.md) dokumentumban található. A skill-ek és agent-ek teljes referenciaútmutatója a [devdocs/skills-and-agents-guide-hu.md](devdocs/skills-and-agents-guide-hu.md) fájlban olvasható.
