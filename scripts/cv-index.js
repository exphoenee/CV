...
(function () {
  ...
  document.getElementById('cv-carousel-next').addEventListener('click', function () {
    goTo(current + 1);
  });
  document.getElementById('cv-carousel-prev').addEventListener('click', function () {
    goTo(current - 1);
  });
