...
export function renderSwaggerContent(data) {
  ...
  parts.push(swgTagSection('summary', swgGet('summary', 'get_summary', '/summary', 'Professional overview', '<p>Returns the professional summary.</p>', null, [{code: '200', bodyHtml: summaryResp, linksHtml: 'No links'}])));
