...
export function renderIdentitySection(data) {
  ...
  var profileResp =
    '<p class="cv-kv"><code>name</code>' +
    E(data.identity.name) +
    '</p><p class="cv-kv"><code>role</code>' +
    E(data.identity.role) +
    ' <em>// "Developer" is an understatement</em></p><p class="cv-kv"><code>location</code>' +
    E(data.identity.location) +
    '</p><p class="cv-kv"><code>accentColor</code>' +
    E(data.meta.accentColor) +
    ' <span class="cv-color-dot"></span></p><p class="cv-kv"><code>deprecated</code>false <em>// still actively maintained</em></p>';
