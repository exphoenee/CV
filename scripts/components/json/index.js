...
export function renderJsonCV(data) {
  ...
  push(
    1,
    html`<span class="c">// Viktor Bozzay - curriculum_vitae.json - v${data.meta.version}</span>`,
  );
  push(1, '<span class="c">// Last commit: 2026-05-07 · still actively maintained</span>');
  push(0, '');
  push(
    1,
    html`<span class="k">"$schema"</span><span class="p">: </span
      ><span class="s"
        >"https://bozzayviktor.hu/schemas/human/developer/v${data.meta.version}.json"</span
      ><span class="p">,</span>`,
  );
