    ...
    <header class="header" role="banner">
      <div class="name-container">
        ...
        <div class="header-buttons" role="group" aria-label="CV actions">
          ...
          <button
            class="hire-btn-plain"
            id="hire-plain-btn"
            aria-label="${locale.t('hireMe')} — open contact form"
          >
            ${locale.t('hireMe')}
          </button>
          <button
            class="book-btn-plain"
            id="plain-booking-btn"
            title="Book a Meeting"
            aria-label="Book a meeting with Viktor"
          >
            <i class="fa-regular fa-calendar-check" aria-hidden="true"></i>
          </button>
          <button
            class="print-btn-plain"
            id="print-plain-btn"
            title="${locale.t('print')}"
            aria-label="${locale.t('print')} CV"
          >
