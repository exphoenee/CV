export const IT = {
  content: {
    summary:
      "Frontend Tech Lead con oltre 5 anni di esperienza frontend, specializzato in architettura frontend, progettazione di sistemi e modernizzazione su larga scala di sistemi legacy con TypeScript, Svelte, React e Node.js. Ho guidato riscritture complete e migrazioni di sistemi aziendali verso stack moderni, migliorando la manutenibilità e la scalabilità delle piattaforme. Ho introdotto flussi di lavoro assistiti dall'IA e costruito pipeline CI con quality gate automatizzati. Guido e mentoro ingegneri, concentrandomi sul refactoring basato su evidenze e su fondamenta frontend sostenibili a livello di sistema.",
    workExperience: [
      {
        id: 'aegex',
        description:
