...
const SOUND_DEFS = {
  footsteps_grass: {
    files: [
      'footsteps_grass_1.wav',
      'footsteps_grass_2.wav',
      'footsteps_grass_3.wav',
      'footsteps_grass_4.wav',
    ],
  },
  footsteps_road: {
    files: [
      'footsteps_road_1.wav',
      'footsteps_road_2.wav',
      'footsteps_road_3.wav',
      'footsteps_road_4.wav',
    ],
  },
...
class SfxManager {
  constructor() {
    this.pool = {};
    this.looping = {};
    const v = parseFloat(localStorage.getItem(SFX_KEY));
    this.volume = Number.isFinite(v) ? v : 0.5;
  }
