export const IT_PAGE = {
  labels: {
    footerRepo: 'Sala macchine',
    footerMail: 'Posta diretta',
    footerLinkedin: 'Profilo LinkedIn',
    portfolio: 'Portfolio',
    ...
    bookRetry: 'Riprova',
    bookErrRetryHint: 'Verifica i tuoi dati e riprova.',
    ...
    bookErrRateLimited: 'Hai già prenotato nelle ultime 24 ore. Riprova più tardi.',
    ...
    errOffensive: "Rimuovi eventuali termini inappropriati dal tuo messaggio.",
    ...
    ganttBook: 'Prenota',
    sbJobDetails: 'Dettagli (facoltativo)',
    sbJobDetailsPh: 'Descrivi le responsabilità…',
    sbJobMinLength: 'Deve contenere almeno 3 caratteri.',
    sbDetailClose: 'Chiudi',
    ...
    ariaPortfolio: 'Apri il portfolio',
  },
};
