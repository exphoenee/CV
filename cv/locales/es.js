...
export const ES = {
  content: {
    summary:
      'Senior Frontend Engineer con 5+ años de experiencia en aplicaciones React y TypeScript. Especializado en arquitectura frontend, estado Redux, componentes reutilizables y optimización de rendimiento. Lideré reescrituras de sistemas empresariales con tests CI (Jest, Vitest, Playwright) y flujos IA que duplicaron la frecuencia de releases. Mentoriro ingenieros, promuevo refactoring basado en evidencias y me enfoco en frontends accesibles y multi-navegador.',
    workExperience: [
      {
        id: 'aegex',
        description:
        ...
        bullets: [
          'Tomé posesión de la arquitectura y entrega de extremo a extremo de dos sistemas empresariales React/TypeScript (SafeSy, FACTS), incluyendo diseño de sistemas, arquitectura UI con gestión de estado estilo Redux, y colaboración cercana con equipos backend y de integración',
          ...
          'Implementé un pipeline CI con pruebas automatizadas (Jest, Vitest, Playwright) y quality gates, construyendo cobertura de pruebas desde cero y reduciendo significativamente los incidentes de producción',
      ...
      },
      {
        ...
        bullets: [
          'Desarrollé componentes UI React type-safe con gestión de estado Redux para sistemas empresariales integrados con IA, colaborando con los equipos backend en flujos de trabajo de integración API',
